...
const fetchWrapper = async (...args: [input: RequestInfo | URL, init?: RequestInit]): Promise<Response | undefined> => {
  try {
    ...
    const requestUrl = typeof args[0] === "string" ? args[0] : String(args[0] || "");

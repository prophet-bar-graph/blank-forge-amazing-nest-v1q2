...
//
// Admin routes do NOT use this model — they go through lib/adminDb.ts which talks
// to MongoDB directly, bypassing the RLS plugin which has no admin escape hatch.
